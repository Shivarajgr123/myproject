...
'''
setattr : To set object value inside object  # UPDATE
getattr : To retrieve IV value           # RETRIEVE 
hasattr : To check object has specific value # RETRIEVE
delattr : To delete object                   # DELETE   
'''
print("------------getter------------------------")
# getter - RETRIEVE
...
print("------------delattr------------------------")
print("Salary : ", getattr(madhu, "sal"))
print("Delete attr :", delattr(madhu, "sal"))
print("Salary : ", getattr(madhu, "sal"))   # ERROR
